...
float cancer_growth(float a, float k, float t, float t0) {
    double result;

    double r1 = exp(-K*(t-t0));
    result = a / (1 + r1);

    return result;  
}

void cell_Age() { // Adjust age of cells in the TME

}

void cancer_Agent(void) { // Actions of the CCs

}

void innate_Immune_Agent(void) { // Actions of the IIS

}

void adaptative_Immune_Agent(void) { // Actions of the AIS

}

void ising_Computations(void) {
